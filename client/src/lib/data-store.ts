...
const initialNotifications: Notification[] = [
  // Budget alerts (6)
  { id: 'notif-1', title: 'MTN Nigeria approaching 85% budget threshold', message: 'MTN Nigeria monthly budget has reached $425,000 of $500,000 allocation. Consider reviewing resource usage or adjusting the budget limit.', category: 'budget', severity: 'critical', isRead: false, timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString() },
  { id: 'notif-2', title: 'Dangote Industries budget at 72% utilization', message: 'Dangote Industries has consumed $180,000 of $250,000 monthly budget. On track to exceed by end of month at current spend rate.', category: 'budget', severity: 'warning', isRead: false, timestamp: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString() },
  { id: 'notif-3', title: 'Flutterwave Q1 budget exceeded', message: 'Flutterwave has exceeded their Q1 budget allocation by 12%. Total spend: $201,600 against $180,000 budget.', category: 'budget', severity: 'critical', isRead: false, timestamp: new Date(Date.now() - 18 * 60 * 60 * 1000).toISOString() },
  { id: 'notif-4', title: 'IT Division sub-budget nearing limit', message: 'Dangote Industries IT Division budget is at 78% ($87,750 of $112,500). Projected to reach threshold in 5 days.', category: 'budget', severity: 'warning', isRead: true, timestamp: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
  ...
  { id: 'notif-6', title: 'New budget created for Access Bank', message: 'A monthly budget of $320,000 has been created for Access Bank with an 80% alert threshold.', category: 'budget', severity: 'info', isRead: true, timestamp: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString() },
  ...
  { id: 'notif-10', title: 'Network egress costs doubled for Zone A', message: 'Cross-region data transfer costs in Zone A have doubled compared to the 30-day average. Investigate potential misconfigured services.', category: 'cost', severity: 'warning', isRead: true, timestamp: new Date(Date.now() - 1.5 * 24 * 60 * 60 * 1000).toISOString() },
  ...
  { id: 'notif-13', title: '3 new rightsizing opportunities identified', message: 'Analysis found 3 ECS instances running at less than 15% CPU utilization. Rightsizing could save $1,240/month.', category: 'optimization', severity: 'info', isRead: false, timestamp: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString() },
  { id: 'notif-14', title: '5 idle resources detected in Dangote Industries', message: '3 unattached EVS volumes and 2 idle ECS instances found. Terminating these resources would save approximately $890/month.', category: 'optimization', severity: 'warning', isRead: false, timestamp: new Date(Date.now() - 12 * 60 * 60 * 1000).toISOString() },
  { id: 'notif-15', title: 'Storage class optimization available', message: '2.4 TB of OBS data in Standard class has not been accessed in 90+ days. Moving to Infrequent Access could save $320/month.', category: 'optimization', severity: 'info', isRead: false, timestamp: new Date(Date.now() - 20 * 60 * 60 * 1000).toISOString() },
  ...
  { id: 'notif-18', title: 'Network optimization opportunity', message: 'Consolidating NAT Gateways across 3 VPCs in Zone B could reduce networking costs by $450/month.', category: 'optimization', severity: 'info', isRead: true, timestamp: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString() },
  ...
  { id: 'notif-20', title: 'Savings plan renewal due in 30 days', message: 'The 1-year compute savings plan for Dangote Industries expires on April 15. Current savings rate: $4,200/month. Review and renew to maintain discounts.', category: 'savings', severity: 'warning', isRead: false, timestamp: new Date(Date.now() - 10 * 60 * 60 * 1000).toISOString() },
  { id: 'notif-21', title: 'New savings plan recommendation', message: 'Based on usage patterns, a 1-year All Upfront reserved instance plan for MTN Nigeria could save $18,500 annually compared to on-demand pricing.', category: 'savings', severity: 'info', isRead: true, timestamp: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString() },
  { id: 'notif-22', title: 'Savings plan coverage report available', message: 'Monthly savings plan coverage report is ready. Overall coverage: 71% of eligible spend. Potential additional savings: $6,800/month with increased commitment.', category: 'savings', severity: 'info', isRead: true, timestamp: new Date(Date.now() - 5.5 * 24 * 60 * 60 * 1000).toISOString() },
];
